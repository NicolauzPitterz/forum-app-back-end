...
const { AddReply, AddedReply, ReplyDetail } = require('../../../Domains');
const {
...
describe('ReplyRepositoryPostgres', () => {
  ...
  describe('verifyReply function', () => {
    it('should resolve if reply exists', async () => {
      ...
      await expect(
        replyRepositoryPostgres.verifyReply(payload.commentId, payload.replyId),
  ...
  describe('getRepliesByCommentId', () => {
    it('should return all replies from a comment', async () => {
      const replies = [
        {
          id: 'reply-123',
      ...
      const repliesDetail = await replyRepositoryPostgres.getRepliesByCommentId(
        'comment-123',
      );
